...
export default {
  ...
  actions: {
    ...
    async SET_COMMENT_TO_API ({ commit, dispatch }, { text, moderation, author, post }) {
      await Axios.post('http://77.66.177.88:8181/api/v1/comments/', {
        text, moderation, author, post
      })
    }
  },
  getters: {
